...
contract StakedXRXToken is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Staked XRX Token", "sXRX", 9) ERC20Permit() {
    ...
    /**
        @notice increases KISS supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess KISS
