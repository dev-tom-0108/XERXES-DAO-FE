...
function Stake() {
  ...
  const onChangeStake = async action => {
    ...
    if (action === "stake" && gweiValue.gt(ethers.utils.parseUnits(ohmBalance, "gwei"))) {
      return dispatch(error("You cannot stake more than your XRX balance."));
    }

    if (action === "unstake" && gweiValue.gt(ethers.utils.parseUnits(sohmBalance, "gwei"))) {
      return dispatch(error("You cannot unstake more than your sXRX balance."));
    }
              ...
              <div className="card-header">
                ...
                {address && oldSohmBalance > 0.01 && (
                  ...
                  >
                    ...
                    <Typography>Migrate sXRX!</Typography>
                  </Link>
                )}
              </div>
            </Grid>
                ...
                <Grid container spacing={2} alignItems="flex-end">
                  ...
                  <Grid item xs={12} sm={4} md={4} lg={4}>
                    <div className="stake-index">
                      ...
                      <Typography variant="h4">
                        {currentIndex ? <>{trim(currentIndex, 1)} XRX</> : <Skeleton width="150px" />}
                      </Typography>
                    </div>
                  </Grid>
                </Grid>
            ...
            <div className="staking-area">
              {!address ? (
                <div className="stake-wallet-notification">
                  ...
                  <Typography variant="h6">Connect your wallet to stake XRX</Typography>
                </div>
              ) : (
                <>
                    ...
                    <Box className="stake-action-row " display="flex" alignItems="center">
                      ...
                      <TabPanel value={view} index={0} className="stake-tab-panel">
                        {address && hasAllowance("ohm") ? (
                          ...
                          >
                            {txnButtonText(pendingTransactions, "staking", "Stake XRX")}
                          </Button>
                        ) : (
                          <Button
                            className="stake-button"
                      ...
                      <TabPanel value={view} index={1} className="stake-tab-panel">
                        {address && hasAllowance("sohm") ? (
                          ...
                          >
                            {txnButtonText(pendingTransactions, "unstaking", "Unstake XRX")}
                          </Button>
                        ) : (
                          <Button
                            className="stake-button"
                  ...
                  <div className={`stake-user-data`}>
                    <div className="data-row">
                      ...
                      <Typography variant="body1">
                        {isAppLoading ? <Skeleton width="80px" /> : <>{trim(ohmBalance, 4)} XRX</>}
                      </Typography>
                    </div>
                    ...
                    <div className="data-row">
                      ...
                      <Typography variant="body1">
                        {isAppLoading ? <Skeleton width="80px" /> : <>{trimmedBalance} sXRX</>}
                      </Typography>
                    </div>
                    ...
                    <div className="data-row">
                      ...
                      <Typography variant="body1">
                        {isAppLoading ? <Skeleton width="80px" /> : <>{nextRewardValue} sXRX</>}
                      </Typography>
                    </div>
