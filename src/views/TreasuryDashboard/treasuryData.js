...
export const tooltipInfoMessages = {
  tvl: "Total Value Deposited, is the dollar amount of all XRX staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.",
  mvt: "Market Value of Treasury Assets, is the sum of the value (in dollars) of all assets held by the treasury.",
  rfv: "Risk Free Value, is the amount of funds the treasury guarantees to use for backing XRX.",
  ...
  holder: "Holders, represents the total number of Ohmies (sXRX holders)",
  staked: "XRX Staked, is the ratio of sXRX to XRX (staked vs unstaked)",
  ...
  runway: "Runway, is the number of days sXRX emissions can be sustained at a given rate. Lower APY = longer runway",
};
