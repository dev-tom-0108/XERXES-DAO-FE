            ...
            <Grid item lg={6} md={6} sm={12} xs={12}>
              <Paper className="ohm-card">
                  <Typography variant="h6" color="textSecondary">
                    ...
                    <InfoTooltip
                      message={
                        "The current index tracks the amount of sXRX accumulated since the beginning of staking. Basically, how much sXRX one would have if they staked and held a single XRX from day 1."
                      }
                    />
                  </Typography>
                  <Typography variant="h5">
                    {currentIndex ? trim(currentIndex, 2) + " sXRX" : <Skeleton type="text" />}
                  </Typography>
                  {/* <Chart
                    type="stack"
                    data={data}
